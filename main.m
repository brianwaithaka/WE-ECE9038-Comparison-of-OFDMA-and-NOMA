...
Conf_.Flag = 1;                  % 0 --> Small urban areas
...
%% 
[Pathloss] = fn_pathloss_OH(Conf_.distances, Conf_.Freq_Carr, Conf_.MBS_ant_height, Conf_.UE_ant_height, Conf_.Flag);
...
title('Comparison Rates: NOMA vs OFDMA');
grid on;
box on;
legend('OFDMA','NOMA')
...
box on;
legend('NOMA','OFDMA')
title('Comparison EE/SE: NOMA vs OFDMA');
hold off;
